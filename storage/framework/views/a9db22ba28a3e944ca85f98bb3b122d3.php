...
<?php $component->withAttributes([]); ?>
    ...
    <form method="POST" action="<?php echo e(route('students.storeRequest', ['id' => $student->id])); ?>">
        <?php echo csrf_field(); ?>
                        ...
                        <select name="class_id" required
                            ...
                            <?php $__currentLoopData = $student->classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($class->id); ?>">
                                    <?php echo e($class->name); ?> - Professor:
                                    <?php echo e($class->professor ? $class->professor->name : 'N/A'); ?>
        ...
        <div class="mt-6 flex items-center justify-end gap-x-6">
            <button type="button" class="text-sm font-semibold leading-6 text-gray-900">
                <a href="<?php echo e(route('students.profile')); ?>">Cancel</a>
            </button>
            <button type="submit"
...
<?php endif; ?>
<?php /**PATH D:\Alyzar\Laravel\Herd\project1\resources\views/students/request.blade.php ENDPATH**/ ?>