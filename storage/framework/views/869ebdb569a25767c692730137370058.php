...
<?php $component->withAttributes([]); ?>
    ...
    <div class="mt-6 flex items-center justify-end gap-x-6">
        <a href="<?php echo e(route('students.requestList')); ?>" class="text-sm font-semibold leading-6 text-gray-900">
            Back to Request List
        </a>

        <?php if($request->status == 'denied'): ?>
            <form action="<?php echo e(route('students.deleteRequest', $request->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
        ...
        <?php elseif($request->status == 'granted'): ?>
            <?php if($request->student->edit): ?>
                <a href="<?php echo e(route('students.edit', ['id' => $request->student_id])); ?>"
...
<?php endif; ?>
<?php /**PATH D:\Alyzar\Laravel\Herd\project1\resources\views/students/requestDetails.blade.php ENDPATH**/ ?>