                        ...
                        <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="flex items-center gap-x-3">
                                <input type="checkbox" name="classes[]" value="<?php echo e($class->id); ?>"
                                    id="class-<?php echo e($class->id); ?>" <?php echo e($isEnrolled ? 'checked' : ''); ?>

                                    <?php echo e(!$isEnrolled && $isFull ? 'disabled' : ''); ?> data-max="<?php echo e($class->sum); ?>"
                                    data-current="<?php echo e($currentCount); ?>">
                                <label for="class-<?php echo e($class->id); ?>"
                                    class="text-sm font-medium leading-6 text-gray-900 <?php echo e(!$isEnrolled && $isFull ? 'text-gray-500' : ''); ?>">
                                    ...
                                    <?php else: ?>
                                        (Available)
                                    <?php endif; ?>
                                    (<span id="class-<?php echo e($class->id); ?>_count"><?php echo e($currentCount); ?></span> /
