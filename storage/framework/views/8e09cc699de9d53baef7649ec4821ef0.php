...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button','data' => ['href' => ''.e(route('students.requestEditForm', ['id' => $student->id])).'','class' => 'bg-blue-600 hover:bg-blue-700']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('students.requestEditForm', ['id' => $student->id])).'','class' => 'bg-blue-600 hover:bg-blue-700']); ?>
            Request Edit
        ...
        <div class="mt-6 border-t border-gray-100">
            <dl>
                ...
                <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0 border-b border-gray-300 last:border-0">
                    ...
                    <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                        <?php echo e($student->date_of_birth); ?></dd>
                </div>
                <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0 border-b border-gray-300 last:border-0">
...
<?php endif; ?>
<?php /**PATH D:\Alyzar\Laravel\Herd\project1\resources\views\students\profile.blade.php ENDPATH**/ ?>