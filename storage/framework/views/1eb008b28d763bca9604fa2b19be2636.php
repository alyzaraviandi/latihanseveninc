                            ...
                            <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" name="classes[]" value="<?php echo e($class->id); ?>"
                                        ...
                                        <?php echo e($isFull ? 'disabled' : ''); ?> data-max="<?php echo e($class->sum); ?>"
                                        data-current="<?php echo e($currentCount); ?>">
                                    <label for="class_<?php echo e($class->id); ?>"
                                        class="ml-2 text-sm font-medium text-gray-900 <?php echo e($isFull ? 'text-gray-500' : ''); ?>">
                                        ...
                                        <?php else: ?>
                                            (Available)
                                        <?php endif; ?>
                                        (<span id="class_<?php echo e($class->id); ?>_count"><?php echo e($currentCount); ?></span> /
                                        <?php echo e($class->sum); ?>)
                                    </label>
                                </div>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mt-6 flex items-center justify-end gap-x-6">
            <!-- Cancel Button -->
            <a href="<?php echo e(route('students.index')); ?>" class="text-sm font-semibold leading-6 text-gray-900">
                Cancel
            </a>
...
<?php endif; ?>
<?php /**PATH D:\Alyzar\Laravel\Herd\project1\resources\views/students/create.blade.php ENDPATH**/ ?>